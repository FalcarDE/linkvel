...
-->
            ...
            <div class="inputs">
                <label>Bildtitel hinzufügen:</label>
                <input placeholder="Bildtitel hinzufügen" id="headline" name="heading" class="heading" type="text">

                <label>Hashtags hinzufügen:</label>
                <input placeholder="Hashtags hinzufügen" id="hashtags" name="hashtags" class="hashtags" type="text">

                <label>Längengrad hinzufügen:</label>
                <input placeholder="Längengrad hinzufügen" name="longitude" class="place" type="number" step="0.01">

                <label>Breitengrad hinzufügen:</label>
                <input placeholder="Breitengrad hinzufügen" name="latitude" class="place" type="number" step="0.01">

                <label>Erlebnis beschreiben:</label>
                <textarea placeholder="Beschreibe hier dein Erlebnis" id="textfile" name="post_textfile"   class="textarea"></textarea>
            </div>
