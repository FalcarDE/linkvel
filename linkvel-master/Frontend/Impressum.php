...
< class="main-container">
    ...
    <div class="sitemap">
        ...
        <li><a href="#16">UserCommentPost</a></li>
        <li><a href="#17">Map-Location</a></li>
        <li><a href="#18">UpdateUserDataByEmployee</a></li>
        <li><a href="#19">DeletePostByEmployee</a></li>
    ...
    <div class="documentation">
        ...
        <h2 id="14">LandingPage – UserPost</h2>
        ...
        <h2 id="18">SearchAccountKey – Ajax</h2>
            <img class="picture" src="../image/changeProfilSite/SearchAccountKey1.png">

        <h2 id="19">UpdateUserDataByEmployee</h2>
